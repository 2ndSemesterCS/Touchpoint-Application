...
namespace TouchpointApp.Persistency
{
    public class KursusCatalog : Catalog<Kursus>
    {
        ...
        #region Metoder
        public void OpretKursus(string titel, DateTime dato, DateTime tidspunkt, string varighed, double pris, string sprog, string beskrivelse, double depositum,  int underviser, int undervisningssted)
        {
